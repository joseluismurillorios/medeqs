export default {
  es: {
    'presentation.one': 'Independientemente de nuestra edad, origen socioeconómico o étnico, consideramos a nuestra salud como nuestro activo más básico y esencial.',
    ...
    'objectives.one': 'Identificar los lugares en la región que carecen de equipos y suministros médicos.',
    'objectives.two': 'Crear un medio de comunicación para asistir a las instituciones de servicios médicos.',
    'objectives.three': 'Solicitar apoyo para proporcionar un servicio inclusivo y digno para el paciente.',
  },
  en: {
    'presentation.one': '',
  },
